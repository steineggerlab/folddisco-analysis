# -*- coding: utf-8 -*-
"""00_generate_simulated_data.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1qiZEXzoLd5Ce9F2YRQ3CI_V1H3VRpCNy
"""
...
def generate_motif_prompt(prompt_length, temperature, motif_count):
    ...
    # Print log
    pdb_name = f"/content/drive/MyDrive/pdb/zinc_finger_{prompt_length}_{temperature}_{motif_count}_{','.join(map(str, motif_starting_indices))}.pdb"
...
def generate_false(prompt_length, temperature, motif_count, repeat):
    sequence_prompt = ["_"] * prompt_length
    sequence_prompt = "".join(sequence_prompt)
    structure_prompt = torch.full((prompt_length, 37, 3), np.nan)
    protein_prompt = ESMProtein(sequence=sequence_prompt, coordinates=structure_prompt)
    ...
    structure_prediction_chain = structure_prediction.to_protein_chain()
    pdb_name = f"/content/drive/MyDrive/pdb/false_{prompt_length}_{temperature}_{motif_count}_{repeat}.pdb"
...
for setting in setting_list:
    for i in range(false_repeat):
        generate_false(*setting, i)
