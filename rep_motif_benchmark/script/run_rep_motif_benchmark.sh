...
# NUM_THREADS=32
NUM_THREADS=8
DEFAULT_FLAGS="-d 0.5 -a 5.0 --header -v"
#FOLDDISCO_INDEX=$1
...
\time ./folddisco query -p query/1G2F.pdb -q F207,F212,F225,F229 -r -i $FOLDDISCO_INDEX -t $NUM_THREADS $DEFAULT_FLAGS --node 4 > result/folddisco/res_mapped/zinc_finger.tsv
